...
const SignIn = props => {
  ...
  const handleSignIn = event => {
    ...
    HTTP.post("/retailer/login", formState.values)
      .then(res => {
        console.log("response: ", res);
        localStorage.setItem("tt", res.headers.authtoken);
        ...
        <Grid className={classes.quoteContainer} item lg={5}>
          <div className={classes.quote}>
            <div className={classes.quoteInner}>
              ...
              >
                Hi ! <br/>
                UseeShop happy to help your business
              </Typography>
            </div>
          </div>
        </Grid>
              ...
              <form className={classes.form} onSubmit={handleSignIn}>
                ...
                {formState.apiError && (
                  <Typography className={classes.title} variant="body2" color="error">
                    username/password is wrong. Please check.
                  </Typography>
                )}
                <Button
